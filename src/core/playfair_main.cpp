...
int main()
{
    ...
    std::cout << "source: " << pf.get_source_text() << std::endl;
    std::cout << "cipher: " << pf.get_cipher_text() << std::endl;
...
//     // Key
//     ks = strlen(key);
//     ks = remove_spaces(key, ks);
//     to_lower_case(key, ks);

//     // Plaintext
//     ps = strlen(str);
//     to_lower_case(str, ps);
//     ps = remove_spaces(str, ps);

//     ps = prepare(str, ps);

//     generate_key_table(key, ks, keyT);
